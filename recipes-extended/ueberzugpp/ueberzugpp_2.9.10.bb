...
SRC_URI = "git://github.com/jstkdng/ueberzugpp.git;protocol=https;branch=master;tag=v${PV}"
...
PACKAGECONFIG ?= "${@bb.utils.filter('DISTRO_FEATURES', 'wayland x11 dbus opengl', d)}"
