...
SRC_URI = "git://github.com/nayuki/QR-Code-generator;protocol=https;nobranch=1;name=qrcodegen;tag=v1.8.0"
SRC_URI += "git://github.com/EasyCoding/qrcodegen-cmake;protocol=https;name=qrcodegen-cmake;subdir=${S}/qrcodegen-cmake;nobranch=1;tag=v1.8.0-cmake4"
