...
SRC_URI = "git://invent.kde.org/frameworks/extra-cmake-modules.git;protocol=https;nobranch=1;tag=v${PV}"
...
PACKAGECONFIG ?= ""
PACKAGECONFIG[qt] = "-DQT_HOST_PATH:PATH=${RECIPE_SYSROOT_NATIVE}${prefix_native},,qttools qtbase-native qttools-native"
